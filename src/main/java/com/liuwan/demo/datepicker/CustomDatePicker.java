...
public class CustomDatePicker implements View.OnClickListener, PickerView.OnSelectListener {
    ...
    private void initView() {
        ...
        if (window != null) {
            dynamicHideNavigationBar(window);
    ...
    public  void dynamicHideNavigationBar(final Window window) {
        //保持布局状态
        int uiOptions = View.SYSTEM_UI_FLAG_LAYOUT_STABLE|
                ...
                View.SYSTEM_UI_FLAG_LAYOUT_FULLSCREEN|0x00001000;
